...
public class FileController<T> {
    // 文件上传存储路径
    private static final String filePath = "C:\\UserFiles\\data\\project\\sign_language\\src\\main\\resources\\static"+"/picture/";
    ...
    public Result upload(MultipartFile file) {
        ...
        return Result.success(http + fileName);  //  http://localhost:9090/files/1697438073596-avatar.png
    }
    ...
    public Dict editorUpload(MultipartFile file){
        ...
        String http = "http://" + ip + ":" + port + "/files/";
        return Dict.create().set("errno",0).set("data", CollUtil.newArrayList(Dict.create().set("url",http+fileName)));
    }
